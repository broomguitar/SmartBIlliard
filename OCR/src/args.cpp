...
DEFINE_string(image_dir, "./imgs/", "Dir of input image.");
DEFINE_string(
	type, "ocr",
...
DEFINE_string(cls_model_dir, "./cls/", "Path of cls inference model.");
DEFINE_double(cls_thresh, 0.9, "Threshold of cls_thresh.");
DEFINE_int32(cls_batch_num, 1, "cls_batch_num.");
// recognition related
DEFINE_string(rec_model_dir, "./rec/", "Path of rec inference model.");
DEFINE_int32(rec_batch_num, 6, "rec_batch_num.");
DEFINE_string(rec_char_dict_path, "./utils/ppocr_keys_v1_ANSI.txt",
	"Path of dictionary.");
...
DEFINE_string(layout_dict_path,
	"./utils/dict/layout_dict/layout_publaynet_dict.txt",
	"Path of dictionary.");
...
DEFINE_string(table_char_dict_path,
	"./utils/dict/table_structure_dict_ch.txt",
	"Path of dictionary.");
